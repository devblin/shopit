...
import { getImageBySize } from '../../../helpers/get';
import Toast from '../../custom/Toast';
import { getItemDetails, updateItem } from '../../../helpers/actions';
...
export default function EditItem(props) {
    ...
    const [previewUrl, setPreviewUrl] = useState(getImageBySize(itemDetails.body.Image, 400));
    ...
    useEffect(() => {
        getItemDetails(itemId, setItemDetails, setAlert, setPreviewUrl);
    }, [isVisible, itemId]);
            ...
            >
                ...
                <Stack width={"100%"} padding={1}>
                    ...
                    <Button
                        ...
                        sx={{ padding: 2 }}
                        onClick={() => {
                            updateItem(itemId, itemDetails, setAlert);
                        }}
                    >
                        Update
                    </Button>
